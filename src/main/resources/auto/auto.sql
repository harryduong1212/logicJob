...
create table job_logic (job_id  bigserial not null, job_checker int8, job_flow int8 not null, job_name varchar(128) not null, job_status varchar(36) not null, job_value int4 not null, job_worker int8, checker_id int8, worker_id int8, primary key (job_id))
