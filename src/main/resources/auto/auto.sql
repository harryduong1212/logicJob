...
create table checker_job (job_id int8, checker_id int8 not null, primary key (checker_id))
create table job_logic (job_id  bigserial not null, job_checker int4, job_name varchar(128) not null, job_status int4 not null, job_value int4 not null, job_worker int4, primary key (job_id))
...
create table worker_job (job_id int8, worker_id int8 not null, primary key (worker_id))
